...
# 文件夹路径
z=912 #频率信息
folder_path = (f'G:\\13')#文件夹路径
result_matrices=[]
lines_to_read = [line for test in range(1) for line in range(test*2050+3, test*2050+2051)]# 要读取的行数列表前2048
...
x_ticks = np.linspace(860, 900, 21) # 设置刻度的起始值、结束值和刻度数量
x_tick_labels = np.linspace(0, 2050, 21)  # 设置刻度对应的标签
